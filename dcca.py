...
# <tr class="opinionTR1"><td class="opinionC1"><a href="/internet/documents/13-BG-955.pdf" target="13-BG-955.pdf">13-BG-955</a></td><td class="opinionC2">In re: Scott B. Gilly</td><td class="opinionC3">Nov 7, 2013</td><td class="opinionC4"></td><td class="opinionC5"></td></tr>
    ...
    def _get_download_urls(self):
        return [t for t in self.html.xpath('//table/tbody/tr/td[1]/a/@href')]
    ...
    def _get_case_dates(self):
        return [date.fromtimestamp(time.mktime(time.strptime(date_string, '%b %d, %Y'))) for date_string in self.html.xpath('//table/tbody/tr/td[3]/text()')]
    ...
    def _get_docket_numbers(self):
        return [t for t in self.html.xpath('//table/tbody/tr/td[1]/a/text()')]